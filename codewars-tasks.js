...
// Task_119. "Count of positives / sum of negatives".
...
// 122. All Star Code Challenge#18 Create a function that accepts a string and a single character, and returns an //integer of the count of occurrences the 2nd argument is found in the first one.
...
function fakeBin(x){ 
  let resultStr = x.replace(/[1-4]/g, "0");
  return resultStr.replace(/[5-9]/g, "1")
}
...
// 127. Correct the mistakes of the character recognition software
